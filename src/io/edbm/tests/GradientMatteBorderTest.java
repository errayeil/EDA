package io.edbm.tests;

//Another example:
import io.edbm.UI.ThemeColors;
import java.awt.*;
    ...
    public JComponent makeUI() {
        Icon icon = new Icon() {
            @Override public void paintIcon(Component c, Graphics g, int x, int y) {
                ...
                float[] dist   = {0.0f, 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 1.0f, };
                
                g2.setPaint(new LinearGradientPaint( start, end, dist, ThemeColors.BORDER_GRADIENT ));
