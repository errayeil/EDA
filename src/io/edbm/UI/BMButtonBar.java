 ...
 * @since 1
 */
public class BMButtonBar extends JPanel {
    ...
    private void createButtons() {
        BMButton bookmark = new BMButton( "Bookmarks" );
        BMButton materials = new BMButton( "Materials" );
        BMButton list = new BMButton( "Shopping list" );
